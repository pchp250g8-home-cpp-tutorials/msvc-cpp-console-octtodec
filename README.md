...
OctToDec. Занятия по C++. ИС Visual Studio. Простой Ввод/Вывод. Алгоритмы. Строки. Платформа Windows. Консольное приложение.
...
Программа делает следующее:
  ...
  6. На экран выводится введённое восьмеричное число и его представление в десятичной системе.
